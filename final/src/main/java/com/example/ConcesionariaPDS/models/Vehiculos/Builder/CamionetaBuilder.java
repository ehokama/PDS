...
public class CamionetaBuilder implements IVehiculoBuilder{
    ...
    public Camioneta getCamioneta(){
        return new Camioneta(marca, modelo, año, color, patente, numeroChasis, numeroMotor, precio, adicionales);
    }
