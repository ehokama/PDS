...
public class Cobranzas extends Area implements HandlerEtapa, IAreaObserver {
    ...
    private HandlerEtapa siguienteHandler = Impuestos.getInstancia() ;;
    ...
    public void handle(OrdenDeCompra ordenDeCompra) {
        ...
        System.out.println("Cobranzas está procesando el pedido #" + ordenDeCompra.getNumeroPedido()); //1. la procesa el area actual
